 ...
 * @author Trent
 */
@WebServlet(name = "DemoteEmployee", urlPatterns = {"/DemoteEmployee"})
public class DemoteEmployee extends HttpServlet {
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (SessionAssister.isRole(request, UserTypes.Administrator)) {
            ...
            if (userName.isEmpty()) {
                ...
                if (!adminManager.demoteEmployee(userName)) {
                    error = "Demoting employee failed.";
                }
            }
