...
public class ppdisplay_car_above1500 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView pp_car_above1500_IDV_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_IDV_value);
        TextView pp_car_above1500_date_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_date_value);
        TextView pp_car_above1500_zone = (TextView) findViewById(R.id.ppdisplay_car_above1500_zone_value);
        TextView pp_car_above1500_cc_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_cc_value);
        TextView pp_car_above1500_nd_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_nd_value);
        TextView pp_car_above1500_uwd_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_uwd_value);
        TextView pp_car_above1500_ncb_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_ncb_value);
        TextView pp_car_above1500_lpg_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_lpg_value);
        TextView pp_car_above1500_lpgtype_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_lpgtype_value);
        TextView pp_car_above1500_antitheft = (TextView) findViewById(R.id.ppdisplay_car_above1500_antitheft_value);

        TextView pp_car_above1500_od_value = (TextView) findViewById(R.id.ppdisplay_car_above1500_od_value);
        TextView pp_car_above1500_value_b = (TextView) findViewById(R.id.ppdisplay_car_above1500_b_value);
        TextView ppdisplay_car_above1500_ab_value= (TextView) findViewById(R.id.ppdisplay_car_above1500_ab_value);
        TextView ppdisplay_car_above1500_lpgkit_value= (TextView) findViewById(R.id.ppdisplay_car_above1500_lpgkit_value);
        TextView ppdisplay_car_above1500_pa_pass_value= (TextView) findViewById(R.id.ppdisplay_car_above1500_pa_pass_value);
        TextView ppdisplay_car_above1500_total_value  = (TextView) findViewById(R.id.ppdisplay_car_above1500_total_value);
        ...
        pp_car_above1500_lpgtype_value.setText(b.getCharSequence("pp_car_above1500_lpgtype_value"));
        ...
        getSupportActionBar().setTitle("Car - Above 1500cc Package Policy");
        ...
        b.getString("pp_car_above1500_lpgtype_value");
        ...
        if((button_value.equals(x) && radio_button_value.equals(yes))){
            ...
            pp_car_above1500_lpgtype_value.setText(b.getString("pp_car_above1500_lpgtype"));
        ...
        String x2="No";
        if((b.getString("pp_car_above1500_nd")).equals(x2))
        {
        ...
        double total=6314.00+pp_lgkit_assumevalue+(double) pp_pa_pass_value;
    ...
    View.OnClickListener listener_ppdisplay_car_above1500_home = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(ppdisplay_car_above1500.this, MainActivity.class);
