...
public class ppdisplay_motorcycle_upto75 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView pp_motorcycle_upto75_IDV_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_IDV_value);
        TextView pp_motorcycle_upto75_date_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_date_value);
        TextView pp_motorcycle_upto75_zone_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_zone_value);
        TextView pp_motorcycle_upto75_cc_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_cc_value);
        TextView pp_motorcycle_upto75_nd_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_nd_value);
        TextView pp_motorcycle_upto75_uwd_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_uwd_value);
        TextView pp_motorcycle_upto75_ncb_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_ncb_value);
        TextView pp_motorcycle_upto75_od_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_od_value);
        TextView pp_motorcycle_upto75_ab_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_ab_value);
        TextView pp_motorcycle_upto75_b_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_b_value);
        TextView ppdisplay_motorcycle_upto75_total_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto75_total_value);
...
//Calculation of ND value
        double nd_value1 = 0;
        String x2 = "No";
        if ((b.getString("pp_motorcycle_upto75_nd")).equals(x2)) {
    ...
    View.OnClickListener listener_ppdisplay_motorcycle_upto75_home = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(ppdisplay_motorcycle_upto75.this, MainActivity.class);
